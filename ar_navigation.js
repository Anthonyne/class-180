            ...
            for (let i = 0; i < steps.length; i++) {
                ...
                if (i > 0) {
                    $("#scene_container").append(
                        `
                            <a-entity gps-entity-place="latitude:41.64287646823139; longitude:-70.93532687333246;">
                                <a-image 
                                    name="${instruction}"
